...
# # Run ECAT
# # tuneChanges = [ ['B3 Exit', 'dB', +0.0005], ['B4 Exit', 'dB', +0.0005], ['WF1 Exit', 'dB', +0.0005] ]   # +0.0016 WF1
...
# #images2compare = [ ["7", ["1638", "1688", "1783"]] ]
...
#
# #tuneChanges = [ ['Q1', 'Y', -0.00037575856111501927], ['Q1', 'B_SC', 0.011297666768643053], ['Q2', 'Y',  -0.0005914722202508483], ['Q2', 'B_SC', -0.001612967967599542], ['Q3', 'B_SC', -0.02234262988240511], ['Q4', 'B_SC', 0.019381765829497632], ['Q5', 'B_SC', -0.0029501097224348145] ]
...
# displaySec = ['VD1515', 'VD1542', 'AP1568 Aperture Drive', 'VD1638']
# plotInterestingCS(displaySec, element_names_stripped, all_x, all_y, transmission_indices)
